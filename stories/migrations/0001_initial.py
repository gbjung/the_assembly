    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_story_relationship', to='base.Author')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
